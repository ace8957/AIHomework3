...
%	iterneraries which span midnight (hour 0) are not supported. If a time span of
%	a length > 24 hours is specified, timeCheck will be false, and that proposition
%	will fail.
